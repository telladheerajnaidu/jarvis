...
export default function SuitDetailPage() {
      ...
      <HudShell session="ERROR">
        <FadeIn>
          <div className="hud-panel hud-corners p-6 text-jarvis-red bg-jarvis-red/5 max-w-xl relative overflow-hidden">
            <BorderBeam colorFrom="#dc2626" colorTo="#b45309" size={40} duration={4} />
  ...
  const integrityColor = integrityBad ? "#dc2626" : suit.integrity.overall < 80 ? "#b45309" : "#fbbf24";
      ...
      <div className="h-full flex flex-col overflow-y-auto pr-1">
        ...
        >
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <ShimmerText className="text-xl sm:text-2xl tracking-[0.3em]" from="#dc2626" mid="#fef2f2" duration={4}>
                {suit.name}
              </ShimmerText>
          ...
          <div className="flex items-center gap-3">
            ...
            <Magnetic strength={0.2}>
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
              >
                <ShineBorder duration={5} colors={["#fbbf24", "#dc2626", "#fbbf24"]} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr_1fr] gap-3 sm:gap-4 mb-4">
          ...
          <FadeIn delay={0.1} direction="left">
            <div className="space-y-4">
              <div className="hud-panel hud-corners p-4 relative overflow-hidden">
                <BorderBeam colorFrom="#fbbf24" colorTo="#991b1b" size={35} duration={10} />
            ...
            <div className="relative flex-1 min-h-[380px] flex items-center justify-center">
              ...
              <svg className="absolute inset-0 m-auto" width="320" height="320" viewBox="0 0 320 320" style={{ opacity: 0.75 }}>
                <g className="ring-rotate-slow" style={{ transformOrigin: "160px 160px" }}>
                  <circle cx="160" cy="160" r="150" fill="none" stroke="#fbbf24" strokeOpacity="0.3" strokeDasharray="4 6" />
                </g>
                <g className="ring-rotate-mid" style={{ transformOrigin: "160px 160px" }}>
                  <circle cx="160" cy="160" r="130" fill="none" stroke="#b45309" strokeOpacity="0.25" strokeDasharray="2 8" />
                </g>
                <line x1="160" y1="5" x2="160" y2="25" stroke="#fbbf24" strokeOpacity="0.5" />
                <line x1="160" y1="295" x2="160" y2="315" stroke="#fbbf24" strokeOpacity="0.5" />
                <line x1="5" y1="160" x2="25" y2="160" stroke="#fbbf24" strokeOpacity="0.5" />
                <line x1="295" y1="160" x2="315" y2="160" stroke="#fbbf24" strokeOpacity="0.5" />
              </svg>
              <SuitSilhouette
                mark={suit.mark}
          ...
          <FadeIn delay={0.2} direction="right">
            <div className="space-y-4">
              <div className="hud-panel hud-corners p-4 relative overflow-hidden">
                <BorderBeam colorFrom="#fbbf24" colorTo="#b45309" size={35} duration={10} delay={2} />
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                  ...
                  <CircularDial label="REACTOR" value={suit.integrity.reactor} unit="%" color="#b45309" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 mb-4">
          ...
          <FadeIn delay={0.4} direction="up">
            <div className="hud-panel hud-corners p-4 relative overflow-hidden">
              <BorderBeam colorFrom="#dc2626" colorTo="#b45309" size={30} duration={12} delay={4} />
